"""HTTP front end.
    ...
    uvicorn web_tools.service:app --host 0.0.0.0 --port 8000
...
while :mod:`web_tools.guard` stops those requests reaching your internal
...
app = FastAPI(title="web-tools", version="0.1.0", lifespan=lifespan)
