"""SSRF perimeter — now a thin shim over :mod:`casanova_core.ssrf`.

The guard used to live here. It moved to the shared ``casanova-core`` package
...
from casanova_core.ssrf import (
    ALLOWED_PORTS,
    ALLOWED_SCHEMES,
    BlockedURL,
    Target,
