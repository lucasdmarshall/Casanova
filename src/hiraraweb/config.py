...
class SearchConfig:
    ...
    #
    # Run `python -m hiraraweb.engine_check` on your own host and set
...
class RobotsConfig:
    ...
    user_agent_token: str = "hirara-web"

    user_agent: str = (
        "Mozilla/5.0 (compatible; hirara-web/0.1; +https://github.com/lucasdmarshall/web_search)"
    )
