...
guard, [`casanova-core`](../casanova-core/).
...
invoices, contracts, medical records, bank statements. CasaOCR is the opposite
...
On a rendered `Hello CasaOCR 12345`, PaddleOCR **without** preprocessing read
...
```bash
uvicorn casaocr.service:app --host 127.0.0.1 --port 8400
```
