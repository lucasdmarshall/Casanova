"""HTTP front end.
    ...
    uvicorn hiraraocr.service:app --host 0.0.0.0 --port 8400
...
log = logging.getLogger("hiraraocr.service")
...
app = FastAPI(title="hiraraocr", version="0.2.0", lifespan=lifespan)
