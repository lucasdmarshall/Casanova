...
Part of the [Casanova](https://github.com/lucasdmarshall/Casanova) tool hub. An
...
```bash
uvicorn casanovacode.service:app --host 127.0.0.1 --port 8300
```
...
```bash
python -m casanovacode.mcp_server
```
