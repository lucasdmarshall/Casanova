"""Tests for the Casanovacode tool layer — schema, envelopes, error handling."""

from __future__ import annotations

import pytest

from casanovacode.config import ExecConfig
from casanovacode.runner import RunnerError
from casanovacode.tools import Toolset
