...
Any Hirara tool that fetches an attacker-influenceable URL should use this
...
class DownloadError(RuntimeError):
    ...
    Security refusals raise :class:`~hirara_core.ssrf.BlockedURL` instead, so
...
async def safe_download(
    ...
    *,
    ...
    Raises :class:`~hirara_core.ssrf.BlockedURL` if the URL (or any redirect
