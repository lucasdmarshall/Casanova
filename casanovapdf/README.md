...
hub's shared SSRF guard, [`casanova-core`](../casanova-core/).
...
```bash
uvicorn casanovapdf.service:app --host 127.0.0.1 --port 8200
```
...
(`CPDF_ALLOW_URL_FETCH=true`), the fetch goes through `casanova-core`'s
