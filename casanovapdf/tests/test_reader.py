...
from casanovapdf.maker import build_pdf
from casanovapdf.reader import ReaderError, inspect_pdf, read_pdf


def _sample(text: str = "Hello Casanova PDF world.", title: str = "Sample") -> bytes:
