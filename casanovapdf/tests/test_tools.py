"""Tests for the Casanovapdf tool layer — schemas, source handling, envelopes."""
...
from casanovapdf.config import PdfConfig
from casanovapdf.tools import (
    PDF_CREATE_SCHEMA,
    PDF_INFO_SCHEMA,
    PDF_READ_SCHEMA,
    Toolset,
...
async def test_url_fetch_routes_through_the_ssrf_guard(monkeypatch):
    ...
    prove casanovapdf actually calls it and surfaces the refusal.
    """
    from casanova_core import BlockedURL
    import casanovapdf.tools as tools_module
