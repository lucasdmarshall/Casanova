...
through the hub's shared SSRF guard, [`hirara-core`](../hirara-core/).
...
It pairs with the hub's other readers: [`hirarapdf`](../hirarapdf/) for PDFs
and [`hiraraocr`](../hiraraocr/) for images and scans. This one owns the Office
formats.
